# Generated by Powerlevel10k configuration wizard on 2021-04-17 at 00:07 -04.
...
# 12h time, slanted separators, slanted heads, round tails, 2 lines, solid, left frame,
...
() {
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=13
  # Custom icon.
