...
local walls_dir = string.format("%s/wallpapers", os.getenv("XDG_DATA_HOME"))
...
theme.bg_urgent = "#f46a66"
theme.bg_minimize = "#21242b"
theme.bg_systray = theme.bg_normal

theme.fg_normal = "#c7c0b3"
theme.fg_focus = "#c7c0b3"
theme.fg_urgent = "#E0E8F8"
theme.fg_minimize = "#c7c0b3"

theme.useless_gap = dpi(6)
theme.border_width = dpi(0)
theme.border_normal = "#22262a"
theme.border_focus = "#3E4556"
theme.border_marked = "#f46a66"
...
theme.hotkeys_modifiers_fg = "#67aec9"
